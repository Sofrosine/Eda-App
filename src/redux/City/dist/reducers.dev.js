...
var cityReducer = function cityReducer() {
  ...
  switch (action.type) {
    case _constants.GET_CITY:
      return _objectSpread({}, state, {
        loading: true
      });

    case _constants.GET_CITY_SUCCESS:
      return _objectSpread({}, state, {
        loading: false,
    ...
    case _constants.GET_CITY_FAILED:
      return _objectSpread({}, state, {
        loading: false,
    ...
    case _constants.RESET_CITY:
      return _objectSpread({}, state, {
        data: []
      });

    case _constants.GET_ONLY_CITY:
      return _objectSpread({}, state, {
